...
int main() {
	...
	GLFWwindow *window = glfwCreateWindow(WIDTH, HEIGHT, "Juárez Huerta Enrique", nullptr, nullptr);
 ...
 //     
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		//primer cubo
		view = glm::translate(glm::mat4(1), glm::vec3(0.0f, -3.3f, -12.0f));
		model = glm::mat4(1);
		model = glm::rotate(model, glm::radians(-90.0f), glm::vec3(0, 1, 0)); // derecha
		...
		//Segundo Cubo
		model = glm::mat4(1);
		model = glm::translate(model, glm::vec3(-4.5f, -3.0f, -12.0f));
		...
		model = glm::mat4(1);
		model = glm::translate(model, glm::vec3(4.5f, -3.0f, -12.0f));
		model = glm::rotate(model, glm::radians(90.0f), glm::vec3(0, 1, 0));  // izquierda
		model = glm::scale(model, glm::vec3(4.0f));
		...
		//Sexto Cubo
		model = glm::mat4(1);
		model = glm::translate(model, glm::vec3(0.0f, 6.50f, -12.0f));
		model = glm::rotate(model, glm::radians(180.0f), glm::vec3(0, 1, 0)); // atrás
		model = glm::scale(model, glm::vec3(4.00f));
		glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
		glDrawArrays(GL_TRIANGLES, 0, 36);

		//Séptimo Cubo
		model = glm::mat4(1);
		model = glm::translate(model, glm::vec3(0.0f, 11.50f, -12.0f));
		model = glm::rotate(model, glm::radians(180.0f), glm::vec3(0, 1, 0)); // atrás
		model = glm::scale(model, glm::vec3(4.00f));
		glUniformMatrix4fv(modelLoc, 1, GL_FALSE, glm::value_ptr(model));
		glDrawArrays(GL_TRIANGLES, 0, 36);
